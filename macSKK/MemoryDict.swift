...
struct MemoryDict: DictProtocol {
     ...
     * 読み込みに失敗した行番号
     */
    private(set) var failedEntryLineNumbers: [Int]
    /**
    ...
    init(dictId: FileDict.ID, source: String, readonly: Bool) {
        ...
        var lineNumber = 0
        var failedEntryLineNumbers: [Int] = []
